...
<head>
    <meta charset="utf-8">
    <title>PHP CRUD Operations using PDO Extension and OOP</title>
...
<div class="row">
<div class="col-md-12">
<h3>PHP CRUD Operations using PDO Extension and OOP</h3> <hr />
...
<a href="../1pdo/logout.php" class="btn btn-large btn-info"><i class="icon-home icon-white"></i> Log me out</a>
